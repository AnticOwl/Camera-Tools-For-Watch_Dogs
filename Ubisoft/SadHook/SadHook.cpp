...
void SadHook::ShowConsole() {
	...
	std::cout << "-		NUMPAD 2-4-8-6                        :         Move Freecam forward, left, backward, right  -" << std::endl;
	std::cout << "-		NUMPAD 9-3                            :         Move Freecam up and down                     -" << std::endl;
	std::cout << "-		NUMPAD 7-1                            :         Freecam Roll left, right                     -" << std::endl;
	std::cout << "-		NUMPAD- + NUMPAD 9-3                  :         Freecam Field Of View increase, decrease     -" << std::endl;
	std::cout << "-		NUMPAD 5                              :         Toggle Depth of Field Mode (Near/Far)        -" << std::endl;
	std::cout << "-		ARROW LEFT-RIGHT                      :         +/- Depth of Field Focal Stop                -" << std::endl;
